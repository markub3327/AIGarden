...
class GardenPlan(models.Model):
    ...
    def get_record(self):
        return self.pk, [self.p_type, self.p_variety, self.p_planting_date.strftime("%d.%m.%Y"), self.p_location]
...
class PlantSpecification(models.Model):
    ...
    input_types = ["str", "str", "int", "range_month", "range", "range", "range", "range", "range_month", "range", "time", "str"] 
